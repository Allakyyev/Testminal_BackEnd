...
.dx-tab.dx-state-hover::after {
  -webkit-border-before: 1px solid #4d4d4d;
  border-block-start: 1px solid #4d4d4d;
...
.dx-tab.dx-tab-selected::after {
  -webkit-border-before: 1px solid #4d4d4d;
  border-block-start: 1px solid #4d4d4d;
  -webkit-border-end: 1px solid #4d4d4d;
  border-inline-end: 1px solid #4d4d4d;
  -webkit-border-after: 1px solid #4d4d4d;
  border-block-end: 1px solid #4d4d4d;
  -webkit-border-start: 1px solid #4d4d4d;
...
.dx-tab.dx-state-active::after {
  -webkit-border-before: 1px solid #525252;
  border-block-start: 1px solid #525252;
  -webkit-border-end: 1px solid #525252;
  border-inline-end: 1px solid #525252;
  -webkit-border-after: 1px solid #525252;
  border-block-end: 1px solid #525252;
...
.dx-tabs.dx-state-focused .dx-tab.dx-state-focused::after {
  -webkit-border-before: 1px solid #579add;
  border-block-start: 1px solid #579add;
  -webkit-border-end: 1px solid #579add;
  border-inline-end: 1px solid #579add;
  -webkit-border-after: 1px solid #579add;
  border-block-end: 1px solid #579add;
  -webkit-border-start: 1px solid #579add;
  border-inline-start: 1px solid #579add;
}
.dx-tabs.dx-state-focused .dx-tab.dx-state-focused.dx-state-disabled::after {
  -webkit-border-before: 1px solid gray;
  border-block-start: 1px solid gray;
  -webkit-border-end: 1px solid gray;
  border-inline-end: 1px solid gray;
  -webkit-border-after: 1px solid gray;
  border-block-end: 1px solid gray;
  -webkit-border-start: 1px solid gray;
...
.dx-editor-outlined .dx-label-before {
  ...
  border-top-color: #4d4d4d;
  border-bottom-color: #4d4d4d;
  border-inline-start-color: #4d4d4d;
  border-start-start-radius: 4px;
  border-end-start-radius: 4px;
  min-width: 5px;
...
.dx-editor-outlined .dx-label-after {
  ...
  border-top-color: #4d4d4d;
  border-bottom-color: #4d4d4d;
  border-inline-end-color: #4d4d4d;
  border-start-end-radius: 4px;
  border-end-end-radius: 4px;
  -webkit-clip-path: inset(-1px -1px -1px 1px);
  clip-path: inset(-1px -1px -1px 1px);
...
.dx-editor-outlined.dx-texteditor-with-label.dx-state-disabled .dx-label-before {
  ...
  border-bottom-color: rgba(222,222,222,.5);
}
...
.dx-calendar-cell.dx-state-hover span {
  background-color: rgba(87,154,221,.24);
  color: #dedede;
}
.dx-calendar-cell.dx-state-active span {
  background-color: rgba(87,154,221,.4);
}
...
.dx-calendar-cell.dx-calendar-contoured-date span {
  box-shadow: 0 0 0 2px rgba(87,154,221,.5);
}
...
.dx-calendar-cell-in-range::before {
  ...
  border-width: 0;
  border-style: dashed;
  border-color: rgba(87,154,221,.6) transparent;
}
...
.dx-calendar-cell-in-range.dx-calendar-range-start-date::before {
  ...
  border-start-start-radius: 4px;
  border-end-start-radius: 4px;
  border-inline-start-color: rgba(87,154,221,0.6);
}
...
.dx-calendar-cell-in-range.dx-calendar-range-end-date::before {
  border-start-end-radius: 4px;
  border-end-end-radius: 4px;
  border-inline-end-color: rgba(87,154,221,0.6);
}
.dx-calendar-cell-in-range.dx-calendar-cell-start-in-row::before {
  inset-inline-start: auto;
  border-start-start-radius: 4px;
...
.dx-tabpanel-tabs-position-top .dx-tabpanel-tab.dx-tab-selected {
  -webkit-border-after: 1px solid #2a2a2a;
...
.dx-tabpanel-tabs-position-right .dx-tabpanel-tab.dx-tab-selected {
  -webkit-border-start: 1px solid #2a2a2a;
...
.dx-tabpanel-tabs-position-bottom .dx-tabpanel-tab.dx-tab-selected {
  -webkit-border-before: 1px solid #2a2a2a;
  border-block-start: 1px solid #2a2a2a;
}
...
.dx-tabpanel-tabs-position-left .dx-tabpanel-tab.dx-tab-selected {
  -webkit-border-end: 1px solid #2a2a2a;
