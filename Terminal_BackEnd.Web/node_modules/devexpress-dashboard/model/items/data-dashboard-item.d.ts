...
*/
import { Disposable, IModelSerializer, ModelSerializer } from '@devexpress/analytics-core/analytics-utils';
...
export declare abstract class DataDashboardItem extends DashboardItem implements IDataItemProvider, IMasterFilterItemsProvider, IColorSignaturesProvider, IDataSourceConsumer {
    ...
    _clientState: ko.Observable<MapClientState | GridClientState>;
    ...
    _attachDataItem(target: Disposable, propertyName: string, link?: DataItemLink): void;
