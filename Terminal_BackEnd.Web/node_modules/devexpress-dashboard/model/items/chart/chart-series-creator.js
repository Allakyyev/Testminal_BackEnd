...
import { HighLowCloseSeries, OpenHighLowCloseSeries, RangeSeries, SimpleSeries, WeightedSeries } from './chart-series';
export class ChartSeriesCreator {
    static getSeriesCreator(dataItemProvider) {
        return (seriesViewType) => {
            ...
            if (series instanceof SimpleSeries) {
                series.seriesType(seriesViewType);
            }
            else if (series instanceof RangeSeries) {
                series.seriesType(seriesViewType);
            }
            else if (series instanceof OpenHighLowCloseSeries) {
                series.seriesType(seriesViewType);
            }
            return series;
        };
    }
    static createSeries(dataItemProvider, seriesJSON, serializer = new ModelSerializer()) {
...
ChartSeriesCreator.chartSeriesTypesMap = {
    'Simple': SimpleSeries,
    'Range': RangeSeries,
    'Weighted': WeightedSeries,
    'OpenHighLowClose': OpenHighLowCloseSeries,
    'HighLowClose': HighLowCloseSeries
};
