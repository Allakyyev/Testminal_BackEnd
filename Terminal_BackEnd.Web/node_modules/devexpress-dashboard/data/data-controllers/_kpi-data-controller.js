...
import { dataControllerBase, DEFAULT_SUBTITLE_SEPARATOR } from './_data-controller-base';
export class kpiDataController extends dataControllerBase {
    ...
    _createSourceItem(axisPoint, kpiElement) {
        var that = this, deltaValue = that._getDeltaValue(axisPoint, kpiElement), measure = that.multiData.getMeasureById(kpiElement.ID), measureValue = that._getMeasureValue(axisPoint, kpiElement), sparklineValues = that._getSparklineValues(axisPoint, kpiElement), getDeltaValue = (getter) => {
            ...
            getSubtitle: function () {
                ...
                if (captions.length > 1)
                    captions.pop();
                return captions.join(DEFAULT_SUBTITLE_SEPARATOR);
            },
        ...
        var sourceItem = {};
        sourceItem[DashboardDataIdField] = kpiElement.ID;
        sourceItem.onIncidentOccurred = RenderHelper.widgetIncidentOccurred;
    ...
    _getStyleSettingsInfo(axisPoint, kpiElementId, ruleFilter) {
        ...
        return this._getStyleSettingsInfoCore(cellInfo, rules, this.viewModel.ColumnAxisName, itemDataAxisNames.defaultAxis);
    }
