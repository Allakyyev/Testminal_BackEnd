...
export function tryLocalize(key) {
    return localize(key) || key;
}
export function getLocalizationById(key) {
    return localize(key) || key;
}
export function formatLocalizable(localizationId, arg1) {
    return format(getLocalizationById(localizationId), getLocalizationById(arg1));
}
