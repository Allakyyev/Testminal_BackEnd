...
import { format as formatter } from '../_formatter';
...
export class itemDataAxisPoint {
    ...
    getValue() {
        var that = this;
        var value = that._getSpecialValue(dataStorageSpecialIds.Value);
    ...
    _getServerText() {
        var that = this;
        return that._getSpecialValue(dataStorageSpecialIds.DisplayText);
    }
    getKey() {
    ...
    getDisplayText() {
        ...
        if (displayText == null) {
            ...
            if (dimension) {
                ...
                displayText = formatter(this.getValue(), format);
            }
        }
        return displayText;
    }
