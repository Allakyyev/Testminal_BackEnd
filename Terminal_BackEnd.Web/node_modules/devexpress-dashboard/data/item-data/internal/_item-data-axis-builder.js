...
*/
import { areNotOrderedListsEqual, RedBlackTree } from '../../_utils';
...
export let itemDataAxisBuilder = {
    build: function (name, storage, dimensions, sortOrderSlices, metaData, iterators) {
        const cache = new RedBlackTree(redBlackTreeNodeComparer);
        ...
        const rootNode = new itemDataAxisPoint(levelInfoList[0], { rowKey: [], sliceKey: levelInfoList[0].dataSlice.getKey() });
                ...
                iterator.forEach(function (dataRowKey) {
                    ...
                    do {
                        ...
                        let createAxisPoint = () => {
                            ...
                            return new itemDataAxisPoint(levelInfo, dataRowKey);
                        };
    ...
    _isSortOrderSlice: function (slice, sortOrderSlices) {
        ...
        if (!result) {
            sortOrderSlices.forEach((orderSlice) => {
                result = result || areNotOrderedListsEqual(slice, orderSlice);
                return !result;
            });
        }
        return result;
