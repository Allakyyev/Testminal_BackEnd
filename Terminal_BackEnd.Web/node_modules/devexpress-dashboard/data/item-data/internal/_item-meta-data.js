...
*/
import { convertToFormat, format as formatter } from '../../_formatter';
...
export class itemMetaData {
    ...
    _createDeltaInfo() {
        var metaData = this._metaDataDto, names = deltaValueNames, deltas = [], valueIdsByDeltaId = {}, formatsByDeltaId = {};
            ...
            metaData.DeltaDescriptors.forEach((_delta) => {
                ...
                switch (_delta.DeltaValueType) {
                    ...
                    case deltaValueTypes.percentOfTarget:
                        ...
                        formats[names.subValue2] = formats[names.absoluteVariation];
                        break;
                    case deltaValueTypes.targetValue:
            ...
            if (_dimensions) {
                _dimensions.forEach((_dimension) => {
                    var dimension = {
                        ...
                        getFormat: function () {
                            return convertToFormat(_dimension.Format);
                        },
                        format: function (value) {
    ...
    getDimensions(axisName) {
        return this.getAxes()[axisName === undefined ? itemDataAxisNames.defaultAxis : axisName];
    }
    getMeasures() {
