...
*/
import { functionDisplay } from '@devexpress/analytics-core/analytics-widgets-internal';
var windowFunctions = {
...
export function getExpressionEditorFunctions() {
    return [dashboardAdvancedFunctions,
        dashboardAggrFunctions]
        .concat(functionDisplay().filter(category => category.display !== 'Aggregate'))
