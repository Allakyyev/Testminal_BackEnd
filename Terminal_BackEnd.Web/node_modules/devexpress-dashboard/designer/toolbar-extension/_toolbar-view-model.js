...
export let toolbarAnimationTime = 500;
export class ToolbarKoViewModel {
    ...
    getKoPopupOptions() {
        ...
        let popupOptions = {
            ...
            animation: {
                show: { type: 'slide', from: { top: -toolboxConstants.menuTitleHeight }, to: { top: 0 }, duration: toolbarAnimationTime },
                hide: { type: 'slide', from: { top: 0 }, to: { top: -toolboxConstants.menuTitleHeight }, duration: toolbarAnimationTime }
            },
            onShowing: (args) => {
