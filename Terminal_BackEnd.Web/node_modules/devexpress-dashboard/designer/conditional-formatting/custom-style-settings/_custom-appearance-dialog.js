...
import { getFieldValue } from '../../form-adapter/_form-adapter-editors';
export class CustomAppearanceDialog {
    constructor(setAppearance, availableFontFamilies) {
        ...
        this.buttonGroup = (args) => {
            ...
            new dxButtonGroup(buttonGroupHolder, options);
        ...
        this.fontStyle = (type, labelLocaleId) => ({
            ...
            hint: getLocalizationById(labelLocaleId),
            dataField: type,
            elementAttr: {
        ...
        this.fontFamilyEditor = (fontFamilies) => (args) => {
            ...
            const initialValue = getFieldValue(args);
            const options = {
                ...
                searchMode: 'contains',
                searchEditorOptions: {
                    placeholder: getLocalizationById('DashboardWebStringId.SearchFontFamilies')
                },
        ...
        this.buttonItems = ko.observableArray([{
                toolbar: 'bottom', location: 'after', widget: 'dxButton', options: {
                    type: 'default',
                    text: getLocalizationById('DashboardWebStringId.ConditionalFormatting.Save'), onClick: () => {
                ...
                toolbar: 'bottom', location: 'after', widget: 'dxButton', options: {
                    text: getLocalizationById('DashboardStringId.ButtonCancel'), onClick: () => this.visible(false)
                }
            }]);
        this.popupOptions = {
            ...
            title: getLocalizationById('DashboardWebStringId.ConditionalFormatting.CustomStyleSettings'),
        };
        this.items = [
            this.appearanceSettingsGroup(),
            {
