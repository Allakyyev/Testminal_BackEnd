...
export class InlineEditCollectionEditorViewModel {
    constructor(params, dataSource) {
        ...
        this.noDataText = getLocalizationById(params.noDataText);
    ...
    getGridOptions() {
        const gridDataSource = new DataSource({
            ...
            update: (key, values) => {
                ...
                return $promiseAdapter(createJQueryDeferred().resolve().promise());
            },
            insert: (newRow) => {
                ...
                return $promiseAdapter(createJQueryDeferred().resolve(newDataSourceItem).promise());
            },
        });
