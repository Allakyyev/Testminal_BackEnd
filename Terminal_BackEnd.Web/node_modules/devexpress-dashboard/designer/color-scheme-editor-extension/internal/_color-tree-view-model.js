...
export class ColorTreeViewModel {
    constructor(params) {
        ...
        this.allowAddNewEntry = safeComputed({ colorSchemeEntries: params.dataSource }, (args) => this.allowModify && args.colorSchemeEntries.some(entry => entry.dimensionKeys().length > 0));
    }
...
export const colorSchemeTreeViewEditor = (options) => context => ({
