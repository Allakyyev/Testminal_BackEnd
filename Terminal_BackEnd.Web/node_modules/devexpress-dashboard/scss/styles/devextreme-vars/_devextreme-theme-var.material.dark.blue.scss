...
$button-default-bg: #03a9f4;
$button-default-hover-bg: #26bafc;
$button-default-focused-bg: #26bafc;
$button-default-active-bg: #88d9fe;
...
$list-expanded-group-color: #03a9f4;
...
$button-group-default-selected-color: #03a9f4;
$button-group-default-selected-bg: rgba(3, 169, 244, 0.22);
...
$switch-on-bg: rgba(3, 169, 244, 0.5);
$switch-handle-on-bg: #03a9f4;
$tabs-tab-color: rgba(255, 255, 255, 0.54);
$tabs-tab-selected-color: #03a9f4;
$tabs-selected-tab-bottom-border-color: #03a9f4;
$tabs-tab-bg: #2f2f38;
...
$texteditor-focused-border-color: #03a9f4;
...
$calendar-cell-selected-bg: #03a9f4;
$calendar-shevron-icon-color: #03a9f4;
$load-indicator-segment-bg-color: #03a9f4;
...
$progressbar-bg: rgba(3, 169, 244, 0.3);
$progressbar-range-bg: #03a9f4;
$progressbar-label-color: #03a9f4;
$tooltip-color: #fff;
$tooltip-bg: black;
$material-slider-bar-bg: rgba(3, 169, 244, 0.24);
$material-slider-bg: #03a9f4;
$material-slider-tooltip-color: rgba(0, 0, 0, 0.87);
$gallery-indicator-bg: #363640;
$gallery-indicator-item-selected-bg: #03a9f4;
$gallery-indicator-focused-bg: #03a9f4;
$gallery-navbutton-hover-color: #03a9f4;
$gallery-navbutton-active-color: #03a9f4;
...
$datagrid-drag-header-border-color: rgba(3, 169, 244, 0.5);
$datagrid-selection-bg: rgba(3, 169, 244, 0.07);
$datagrid-row-selected-border-color: #515159;
$datagrid-row-selected-color: #fff;
$datagrid-row-focused-color: rgba(0, 0, 0, 0.87);
$datagrid-row-focused-bg: #0d92d0;
...
$datagrid-search-bg: #03a9f4;
$datagrid-row-error-color: white;
$datagrid-row-error-bg: #a83e3a;
$datagrid-focused-border-color: #0d92d0;
...
$scheduler-appointment-base-color: #03a9f4;
$scheduler-appointment-start-color: rgba(0, 0, 0, 0.3);
$scheduler-workspace-focused-cell-color: rgba(3, 169, 244, 0.12);
$scheduler-first-month-border-color: #515159;
$scheduler-current-time-cell-color: #03a9f4;
...
$filterbuilder-item-field-color: rgba(3, 169, 244, 0.3);
