...
*/
import { currentTheme, getTheme } from 'devextreme/viz/themes';
...
export class geoPointMapItemBase extends mapItem {
    ...
    renderContentUnsafe(element, changeExisting, afterRenderCallback) {
        var options = deepExtend(this._getMapViewerOptions(), this._getGeoPointMapViewerOptions());
    ...
    _getWeightLegend(viewModel) {
        ...
        if (legend) {
            ...
            legend.markerColor = getTheme(currentTheme()).map['layer:area'].color;
