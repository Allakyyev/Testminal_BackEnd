...
import { dashboardSelectionMode } from '../_interactivity-controller';
var PAGE_SIZE = 100;
export class filterElementBaseItem extends baseItem {
    ...
    updateInteractivityOptions() {
        this.interactivityController.setOptions(this.isMultiSelectable ? dashboardSelectionMode.multiple : dashboardSelectionMode.single);
