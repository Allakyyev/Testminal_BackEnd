...
import dxPivotGrid, { Properties as dxPivotGridOptions, Cell as dxPivotGridPivotGridCell } from 'devextreme/ui/pivot_grid';
...
import { DataPoint, ViewerItemInfo, ViewerItemOptions, baseItem } from '../_base-item';
export declare class pivotGridItem extends baseItem {
    ...
    protected _createTestableWidget(element: HTMLElement, options: dxPivotGridOptions): dxPivotGrid;
