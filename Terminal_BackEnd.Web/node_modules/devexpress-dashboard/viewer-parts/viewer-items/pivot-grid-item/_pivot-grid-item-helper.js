...
export let pivotHelper = {
    ...
    getColumnAxis(multiData) {
        return multiData.getAxis(itemDataAxisNames.pivotColumnAxis);
    },
    getRowAxis(multiData) {
        return multiData.getAxis(itemDataAxisNames.pivotRowAxis);
    }
};
...
export class FilterChecker extends FilterValueVisitor {
...
export class OneElementFilterRemover extends FilterValueVisitor {
...
export class FieldsExtractor extends FilterValueVisitor {
    static extract(filter) {
        return distinct(FieldsExtractor._instance._visit(filter));
    }
    _visitEmpty(filter) {
        return [];
    }
