...
import { tooltipContainerSelector } from '../../data/_utils';
import { zIndex } from '../../data/_z-index';
import { indicatorType as indicatorTypeDict } from '../widgets/indicators/_consts';
...
export class choroplethMapItem extends mapItem {
    ...
    renderContentUnsafe(element, changeExisting, afterRenderCallback) {
        var options = deepExtend(this._getMapViewerOptions(), this._getChoroplethMapViewerOptions());
    ...
    _getDeltaColorValue(indicatorType, isGood) {
        switch (indicatorType) {
            case indicatorTypeDict.up:
            case indicatorTypeDict.down:
                return isGood ? 2.5 : 0.5;
            case indicatorTypeDict.warning:
                return 1.5;
            default:
                return -1;
        }
