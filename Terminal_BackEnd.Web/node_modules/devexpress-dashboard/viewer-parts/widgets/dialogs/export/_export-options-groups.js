...
import { createJQueryCallbacks, deepExtend } from '../../../../data/_jquery-helpers';
import { localizationId } from '../../../../data/_localization-ids';
import { localizer } from '../../../../data/_localizer';
import { dashboardExportExcelFormat } from '../../../_export-options';
import { dialogClasses } from '../_dialog-form';
...
let dialogEditorFactory = {
    dxTagBox: { name: 'dxTagBox', create: (element, options) => new dxTagBox(element, options) },
    dxSelectBox: { name: 'dxSelectBox', create: (element, options) => new dxSelectBox(element, options) },
    dxRadioGroup: { name: 'dxRadioGroup', create: (element, options) => new dxRadioGroup(element, options) },
    dxNumberBox: { name: 'dxNumberBox', create: (element, options) => new dxNumberBox(element, options) },
    dxTextBox: { name: 'dxTextBox', create: (element, options) => new dxTextBox(element, options) },
    dxCheckBox: { name: 'dxCheckBox', create: (element, options) => new dxCheckBox(element, options) },
    dxDateBox: { name: 'dxDateBox', create: (element, options) => new dxDateBox(element, options) }
};
export class labeledEditor {
    ...
    _initialize() {
        var that = this;
        var controlOptions = deepExtend(that._getControlOptions(that._options), that._options.controlOptions || {});
        ...
        that.labelDiv.classList.add(dialogClasses.name);
        ...
        that.editorDiv.classList.add(dialogClasses.box);
    ...
    setEnabled(enabled) {
        ...
        if (enabled) {
            that.labelDiv.classList.remove(dialogClasses.disabledName);
        }
        else {
            that.labelDiv.classList.add(dialogClasses.disabledName);
        }
    ...
    _getControlOptions(options) {
        switch (options.controlCreator.name) {
            case dialogEditorFactory.dxSelectBox.name:
                return {
                    dataSource: {
                        store: new ArrayStore(options.values),
                        paginate: false
                    },
                    ...
                    valueExpr: 'value',
                    valueName: 'value',
                    placeholder: localizer.getString(localizationId.FilterElementCheckedComboBoxNoDataCaption),
                    noDataText: localizer.getString(localizationId.FilterElementNoDataToDisplay),
    ...
    _generateElementNameClassName(controlCreator, largeMargin) {
        if (largeMargin)
            return dialogClasses.name + '-margin-top';
        if ((controlCreator == dialogEditorFactory.dxRadioGroup.name) || (controlCreator == dialogEditorFactory.dxCheckBox.name)) {
            return dialogClasses.name + '-top';
        }
        return dialogClasses.name + '-middle';
    }
    _getElementClassName(controlName, largeMargin) {
        if (largeMargin)
            return dialogClasses.elementLargeMarginTop;
        switch (controlName) {
            case dialogEditorFactory.dxSelectBox.name:
            case dialogEditorFactory.dxTextBox.name:
                return dialogClasses.elementTextBox;
            case dialogEditorFactory.dxNumberBox.name:
                return dialogClasses.elementNumberBox;
            default:
                return '';
        }
    }
...
export class dashboardStateOptionsGroup extends optionsGroup {
    ...
    _initialize() {
        ...
        this.exportFilters = new labeledEditor({
            labelText: localizer.getString(localizationId.labelName.IncludeExportDashboardState),
            controlCreator: dialogEditorFactory.dxCheckBox,
            margin: 'Large',
            controlOptions: {
                text: localizer.getString(localizationId.labelName.ExportFilters),
        ...
        this.exportParameters = new labeledEditor({
            ...
            margin: 'Small',
            controlOptions: {
                text: localizer.getString(localizationId.labelName.ExportParameters),
                onValueChanged: function (args) {
        ...
        this.dashboardStatePosition = new labeledEditor({
            labelText: localizer.getString(localizationId.labelName.DashboardStatePosition),
            controlCreator: dialogEditorFactory.dxSelectBox,
            values: [dashboardStatePosition.below, dashboardStatePosition.separatePage],
...
export class captionOptionsGroup extends optionsGroup {
    ...
    _initialize() {
        ...
        this.showCaption = new labeledEditor({
            labelText: localizer.getString(localizationId.labelName.ShowTitle),
            controlCreator: dialogEditorFactory.dxCheckBox,
            controlOptions: {
                onValueChanged: function (args) {
        ...
        this.caption = new labeledEditor({
            labelText: localizer.getString(localizationId.labelName.Title),
...
export class scaleModeOptionsGroup extends optionsGroup {
    constructor(_scaleModeValue) {
        ...
        this.visibilityUpdated = createJQueryCallbacks();
    }
    _initialize() {
        var that = this;
        this.scaleMode = new labeledEditor({
            labelText: localizer.getString(localizationId.labelName.ScaleMode),
            controlCreator: dialogEditorFactory.dxSelectBox,
            values: [scaleMode.none, scaleMode.useScaleFactor, scaleMode.autoFitToPageWidth],
            controlOptions: {
                onValueChanged: function (args) {
        ...
        this.scaleFactor = new labeledEditor({
            labelText: localizer.getString(localizationId.labelName.ScaleFactor),
            controlCreator: dialogEditorFactory.dxNumberBox
        });
        this.autoFitPageCount = new labeledEditor({
            labelText: localizer.getString(localizationId.labelName.AutoFitPageCount),
            controlCreator: dialogEditorFactory.dxNumberBox
        });
...
export class documentOptionsGroup extends optionsGroup {
    ...
    _initialize() {
        this.pageLayout = new labeledEditor({
            labelText: localizer.getString(localizationId.labelName.PageLayout),
            controlCreator: dialogEditorFactory.dxRadioGroup,
            values: [pageLayout.portrait, pageLayout.landscape]
        });
        this.paperKind = new labeledEditor({
            labelText: localizer.getString(localizationId.labelName.PaperKind),
            controlCreator: dialogEditorFactory.dxSelectBox,
            values: [paperKind.letter, paperKind.legal, paperKind.executive, paperKind.a5, paperKind.a4, paperKind.a3],
            controlOptions: { container: this._additionalOptions.popupContainer }
        });
...
export class textItemOptionsGroup extends optionsGroup {
    ...
    _initialize() {
        this.fileName = new labeledEditor({
            labelText: localizer.getString(localizationId.labelName.FileName),
            controlCreator: dialogEditorFactory.dxTextBox
        });
...
export class dashboardOptionsGroup extends optionsGroup {
    ...
    _initialize() {
        ...
        this.pageLayout = new labeledEditor({
            labelText: localizer.getString(localizationId.labelName.PageLayout),
            controlCreator: dialogEditorFactory.dxRadioGroup,
            values: [pageLayout.portrait, pageLayout.landscape, pageLayout.auto],
            controlOptions: {
                onValueChanged: function (args) {
    ...
    createEditors(additionalOptions) {
        ...
        if (this._dashboardAutomaticPageLayoutValue)
            this._setScaleModeOptionsVisibility(pageLayout.auto.value);
    }
    set(documentInfo) {
        this.pageLayout.set(documentInfo.pdfExportOptions.DashboardAutomaticPageLayout ? pageLayout.auto.value : documentInfo.pdfExportOptions.PageLayout);
        this.paperKind.set(documentInfo.pdfExportOptions.PaperKind);
        this.scaleModeOptionsGroup.set(documentInfo);
        this.fileName.set(documentInfo.fileName);
    }
    apply(documentInfo) {
        if (this.pageLayout.get() != pageLayout.auto.value)
            documentInfo.pdfExportOptions.PageLayout = this.pageLayout.get();
        documentInfo.pdfExportOptions.DashboardAutomaticPageLayout = this.pageLayout.get() == pageLayout.auto.value;
        documentInfo.pdfExportOptions.PaperKind = this.paperKind.get();
        this.scaleModeOptionsGroup.apply(documentInfo);
        documentInfo.fileName = this.fileName.get();
    }
    ...
    _setScaleModeOptionsVisibility(pageLayoutValue) {
        this.scaleModeOptionsGroup.setEnabled(pageLayoutValue != pageLayout.auto.value);
    }
}
export class gridOptionsGroup extends optionsGroup {
    ...
    _initialize() {
        ...
        this.printHeadersOnEveryPage = new labeledEditor({
            labelText: localizer.getString(localizationId.labelName.PrintHeadersOnEveryPage),
            controlCreator: dialogEditorFactory.dxCheckBox
        });
        this.fitToPageWidth = new labeledEditor({
            labelText: localizer.getString(localizationId.labelName.FitToPageWidth),
            controlCreator: dialogEditorFactory.dxCheckBox,
            controlOptions: {
                onValueChanged: function (args) {
                    that._setScaleModeOptionsVisibility(args.component.option('value'));
...
export class chartOptionsGroup extends optionsGroup {
    ...
    _initialize() {
        ...
        this.sizeMode = new labeledEditor({
            labelText: localizer.getString(localizationId.labelName.SizeMode),
            controlCreator: dialogEditorFactory.dxRadioGroup,
            values: [sizeMode.none, sizeMode.stretch, sizeMode.zoom]
        });
        this.fileName = new labeledEditor({
            labelText: localizer.getString(localizationId.labelName.FileName),
            controlCreator: dialogEditorFactory.dxTextBox
    ...
    set(documentInfo) {
        this.pageLayout.set(documentInfo.pdfExportOptions.ChartAutomaticPageLayout ? pageLayout.auto.value : documentInfo.pdfExportOptions.PageLayout);
        this.paperKind.set(documentInfo.pdfExportOptions.PaperKind);
        this.captionOptionsGroup.set(documentInfo);
    ...
    apply(documentInfo) {
        if (this.pageLayout.get() != pageLayout.auto.value)
            documentInfo.pdfExportOptions.PageLayout = this.pageLayout.get();
        documentInfo.pdfExportOptions.ChartAutomaticPageLayout = this.pageLayout.get() == pageLayout.auto.value;
        documentInfo.pdfExportOptions.PaperKind = this.paperKind.get();
        this.captionOptionsGroup.apply(documentInfo);
...
export class mapOptionsGroup extends optionsGroup {
    ...
    _initialize() {
        ...
        this.sizeMode = new labeledEditor({
            labelText: localizer.getString(localizationId.labelName.SizeMode),
            controlCreator: dialogEditorFactory.dxRadioGroup,
            values: [sizeMode.none, sizeMode.zoom]
        });
        this.fileName = new labeledEditor({
            labelText: localizer.getString(localizationId.labelName.FileName),
            controlCreator: dialogEditorFactory.dxTextBox
    ...
    set(documentInfo) {
        this.pageLayout.set(documentInfo.pdfExportOptions.MapAutomaticPageLayout ? pageLayout.auto.value : documentInfo.pdfExportOptions.PageLayout);
        this.paperKind.set(documentInfo.pdfExportOptions.PaperKind);
        this.captionOptionsGroup.set(documentInfo);
    ...
    apply(documentInfo) {
        if (this.pageLayout.get() != pageLayout.auto.value)
            documentInfo.pdfExportOptions.PageLayout = this.pageLayout.get();
        documentInfo.pdfExportOptions.MapAutomaticPageLayout = this.pageLayout.get() == pageLayout.auto.value;
        documentInfo.pdfExportOptions.PaperKind = this.paperKind.get();
        this.captionOptionsGroup.apply(documentInfo);
...
export class treemapOptionsGroup extends optionsGroup {
    ...
    set(documentInfo) {
        this.pageLayout.set(documentInfo.pdfExportOptions.TreemapAutomaticPageLayout ? pageLayout.auto.value : documentInfo.pdfExportOptions.PageLayout);
        this.paperKind.set(documentInfo.pdfExportOptions.PaperKind);
        this.captionOptionsGroup.set(documentInfo);
    ...
    apply(documentInfo) {
        if (this.pageLayout.get() != pageLayout.auto.value)
            documentInfo.pdfExportOptions.PageLayout = this.pageLayout.get();
        documentInfo.pdfExportOptions.TreemapAutomaticPageLayout = this.pageLayout.get() == pageLayout.auto.value;
        documentInfo.pdfExportOptions.PaperKind = this.paperKind.get();
        this.captionOptionsGroup.apply(documentInfo);
...
export class rangeFilterOptionsGroup extends optionsGroup {
    ...
    set(documentInfo) {
        this.pageLayout.set(documentInfo.pdfExportOptions.RangeFilterAutomaticPageLayout ? pageLayout.auto.value : documentInfo.pdfExportOptions.PageLayout);
        this.paperKind.set(documentInfo.pdfExportOptions.PaperKind);
        this.captionOptionsGroup.set(documentInfo);
    ...
    apply(documentInfo) {
        if (this.pageLayout.get() != pageLayout.auto.value)
            documentInfo.pdfExportOptions.PageLayout = this.pageLayout.get();
        documentInfo.pdfExportOptions.RangeFilterAutomaticPageLayout = this.pageLayout.get() == pageLayout.auto.value;
        documentInfo.pdfExportOptions.PaperKind = this.paperKind.get();
        this.captionOptionsGroup.apply(documentInfo);
...
export class pieOptionsGroup extends optionsGroup {
    ...
    _initialize() {
        ...
        this.autoArrangeContent = new labeledEditor({
            labelText: localizer.getString(localizationId.labelName.AutoArrangeContent),
            controlCreator: dialogEditorFactory.dxCheckBox,
            controlOptions: {
                onValueChanged: function (args) {
                    that._setScaleModeOptionsVisibility(args.component.option('value'));
...
export class imageOptionsGroup extends optionsGroup {
    ...
    _initialize() {
        ...
        this.imageFormat = new labeledEditor({
            labelText: localizer.getString(localizationId.labelName.ImageFormat),
            controlCreator: dialogEditorFactory.dxSelectBox,
            values: [imageFormat.png, imageFormat.gif, imageFormat.jpg],
            controlOptions: { container: this._additionalOptions.popupContainer }
        });
        this.showTitle = new labeledEditor({
            labelText: localizer.getString(localizationId.labelName.ShowTitle),
        ...
        this.resolution = new labeledEditor({
            labelText: localizer.getString(localizationId.labelName.Resolution),
            controlCreator: dialogEditorFactory.dxNumberBox
        });
        this.fileName = new labeledEditor({
            labelText: localizer.getString(localizationId.labelName.FileName),
...
export class dashboardExcelOptionsGroup extends optionsGroup {
    ...
    _checkExportFormat(format) {
        return format === excelFormat.csv.value;
    }
    _initialize() {
        var that = this;
        this.excelFormat = new labeledEditor({
            labelText: localizer.getString(localizationId.labelName.ExcelFormat),
            controlCreator: dialogEditorFactory.dxSelectBox,
            values: [excelFormat.xlsx, excelFormat.xls],
            controlOptions: {
                onValueChanged: function (args) {
        ...
        this.dashboardStatePosition = new labeledEditor({
            labelText: localizer.getString(localizationId.labelName.DashboardStatePosition),
            controlCreator: dialogEditorFactory.dxSelectBox,
            values: [excelDashboardStatePosition.below, excelDashboardStatePosition.separateSheet],
            controlOptions: { container: this._additionalOptions.popupContainer }
        });
    ...
    set(documentInfo) {
        this.fileName.set(documentInfo.fileName);
        var format = documentInfo.excelExportOptions.Format === dashboardExportExcelFormat.csv ? dashboardExportExcelFormat.xlsx : documentInfo.excelExportOptions.Format;
...
export class excelOptionsGroup extends optionsGroup {
    ...
    _initialize() {
        ...
        this.excelFormat = new labeledEditor({
            labelText: localizer.getString(localizationId.labelName.ExcelFormat),
            controlCreator: dialogEditorFactory.dxSelectBox,
            values: this._enableCsv ? [excelFormat.xlsx, excelFormat.xls, excelFormat.csv] : [excelFormat.xlsx, excelFormat.xls],
            controlOptions: {
                onValueChanged: function (args) {
                    var isCsv = that._checkExportFormat(args.component.option('value'));
        ...
        this.separator = new labeledEditor({
            labelText: localizer.getString(localizationId.labelName.CsvValueSeparator),
            controlCreator: dialogEditorFactory.dxTextBox
        });
    ...
    set(documentInfo) {
        this.fileName.set(documentInfo.fileName);
        var format = documentInfo.excelExportOptions.Format === dashboardExportExcelFormat.csv && !this._enableCsv ? dashboardExportExcelFormat.xlsx : documentInfo.excelExportOptions.Format;
        this.excelFormat.set(format);
