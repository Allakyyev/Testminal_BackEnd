...
export class RenderHelper {
    ...
    static getScrollable(element) {
        return dxScrollView.getInstance(element);
    }
    ...
    static wrapScrollable(container, parentOverflow, direction) {
        ...
        if (container) {
            var scrollableInstance = dxScrollView.getInstance(container);
            if (scrollableInstance) {
                scrollableInstance.option(scrollableOptions);
            }
            else {
                scrollableInstance = new dxScrollView(container, scrollableOptions);
            }
            scrollableContent = $unwrap(scrollableInstance.content());
        }
...
__decorate([
    cacheable('getBorderSizeByClasses')
], RenderHelper, "getBorderSizeByClasses", null);
export function createFakeObjects(classNames, cssOptions) {
