...
export class ExportOptions {
    ...
    convertToExportOptions(clientOptions) {
        ...
        let pdfOptions = {
            ...
            ShowTitle: type.isDefined(clientPdfOptions.ShowTitle) ? clientPdfOptions.ShowTitle !== 'False' && clientPdfOptions.ShowTitle !== false : currentPdfOptions.ShowTitle,
            ...
            ExportParameters: type.isDefined(clientDashboardPdfOptions.ExportParameters) ? clientDashboardPdfOptions.ExportParameters : currentPdfOptions.ExportParameters,
            ...
            IncludeHiddenParameters: type.isDefined(clientDashboardPdfOptions.IncludeHiddenParameters) ? clientDashboardPdfOptions.IncludeHiddenParameters : currentPdfOptions.IncludeHiddenParameters,
            FontInfo: {
        ...
        let imageOptions = {
            ...
            ExportParameters: type.isDefined(clientDashboardImageOptions.ExportParameters) ? clientDashboardImageOptions.ExportParameters : currentImageOptions.ExportParameters,
            ScaleFactor: clientImageOptions.ScaleFactor || currentImageOptions.ScaleFactor,
            ShowTitle: type.isDefined(clientImageOptions.ShowTitle) ? clientImageOptions.ShowTitle !== 'False' && clientImageOptions.ShowTitle !== false : currentImageOptions.ShowTitle,
            IncludeHiddenParameters: type.isDefined(clientDashboardImageOptions.IncludeHiddenParameters) ? clientDashboardImageOptions.IncludeHiddenParameters : currentImageOptions.IncludeHiddenParameters,
            FontInfo: {
        ...
        let excelOptions = {
            ...
            IncludeHiddenParameters: type.isDefined(clientExcelOptions.IncludeHiddenParameters) ? clientExcelOptions.IncludeHiddenParameters : currentExcelOptions.IncludeHiddenParameters
        };
    ...
    _getDefinedValue(oldOptions, oldProperty, newValue, currentValue) {
        if (type.isDefined(oldOptions))
            return oldOptions[oldProperty];
        if (type.isDefined(newValue))
            return newValue;
        return currentValue;
    }
    _getExportFilters(clientOptions, currentValue) {
        if (type.isDefined(clientOptions.ExportFilters))
            return clientOptions.ExportFilters;
        if (type.isDefined(clientOptions.FilterState))
            return clientOptions.FilterState !== 'None';
        return currentValue;
    }
    _getDashboardAutomaticPageLayout(clientOptions, currentValue) {
        if (type.isDefined(clientOptions.DashboardAutomaticPageLayout))
            return clientOptions.DashboardAutomaticPageLayout;
        if (type.isDefined(clientOptions.ScaleMode))
            return clientOptions.ScaleMode === dashboardExportScaleMode.autoFitWithinOnePage;
        return currentValue;
    }
    _convertDocumentScaleModeToScaleMode(documentScaleMode, dashboardAutomaticPageLayout) {
        switch (documentScaleMode) {
            case dashboardExportDocumentScaleMode.autoFitToPagesWidth:
                return dashboardExportScaleMode.autoFitToPageWidth;
            case dashboardExportDocumentScaleMode.useScaleFactor:
                return dashboardExportScaleMode.useScaleFactor;
            default:
                return dashboardAutomaticPageLayout ? dashboardExportScaleMode.autoFitWithinOnePage : dashboardExportScaleMode.none;
        }
    }
    _convertScaleModeToDocumentScaleMode(scaleMode) {
        switch (scaleMode) {
            case dashboardExportScaleMode.autoFitToPageWidth:
                return dashboardExportDocumentScaleMode.autoFitToPagesWidth;
            case dashboardExportScaleMode.useScaleFactor:
                return dashboardExportDocumentScaleMode.useScaleFactor;
            default:
                return dashboardExportDocumentScaleMode.none;
        }
    }
    _getPdfFilterState() {
    ...
    _correctImageFormat(imageFormat) {
        return imageFormat === 'Jpeg' ? dashboardExportImageFormat.jpg : imageFormat;
    }
}
