...
import { getBaseColorScheme } from '../_dx-devextreme-themes-integration';
var AppearanceType = {
    WhiteColor: '#FFFFFF',
...
export class appearanceSettingsProvider {
    ...
    static toCssProperties(appearanceType, drawProperty) {
        ...
        const styles = getEmptyCssPropertyWrappersArray();
        if (drawProperty == null || drawProperty.shouldDrawBackColorStyle)
            styles.push(createCssPropertyWrapper('background-color', appearanceSettingsProvider._getBackColorFromPredefinedStyle(appearanceType, isDark)));
    ...
    static toCustomCssProperties(appearance) {
        ...
        if (appearance.backColor()) {
            styles.push(createCssPropertyWrapper('background-color', appearance.backColor().css));
        }
        if (appearance.foreColor()) {
            styles.push(createCssPropertyWrapper('color', appearance.foreColor().css));
        }
        if (appearance.fontFamily()) {
            styles.push(createCssPropertyWrapper('font-family', appearance.fontFamily()));
        }
        ...
        fontStyleWrapper.bold ?
            ...
            styles.push(createCssPropertyWrapper('font-weight', 'initial'));
        fontStyleWrapper.italic ?
            styles.push(this._createFontItalic()) :
            styles.push(createCssPropertyWrapper('font-style', 'initial'));
        fontStyleWrapper.underline ?
            styles.push(this._createFontUnderline()) :
            styles.push(createCssPropertyWrapper('text-decoration', 'initial'));
        return styles;
    }
    static _createFontBold() {
        return createCssPropertyWrapper('font-weight', 'bold');
    }
    static _createFontItalic() {
        return createCssPropertyWrapper('font-style', 'italic');
    }
    static _createFontUnderline() {
        return createCssPropertyWrapper('text-decoration', 'underline');
    }
    static _createFontStyles(appearanceType, isDark) {
        switch (appearanceType) {
            ...
            case 'FontGrayed':
                return createCssPropertyWrapper('color', AppearanceType.GrayedTextColor);
            case 'FontRed':
                return createCssPropertyWrapper('color', (isDark ? AppearanceType.DarkRedColor : AppearanceType.LightRedColor));
            case 'FontYellow':
                return createCssPropertyWrapper('color', (isDark ? AppearanceType.DarkYellowColor : AppearanceType.LightYellowColor));
            case 'FontGreen':
                return createCssPropertyWrapper('color', (isDark ? AppearanceType.DarkGreenColor : AppearanceType.LightGreenColor));
            case 'FontBlue':
                return createCssPropertyWrapper('color', (isDark ? AppearanceType.DarkBlueColor : AppearanceType.LightBlueColor));
            default:
                ...
                if (color !== undefined)
                    return createCssPropertyWrapper('color', AppearanceType.WhiteColor);
                return null;
        }
    }
    ...
    static isDarkColorScheme() {
        return getBaseColorScheme() === 'dark';
    }
}
