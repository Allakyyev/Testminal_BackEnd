...
import { DashboardLayoutItemPlaceholder } from '../../../model/layout/_layout-item-placeholder';
...
export interface ILayoutItemViewModel extends IDisposable {
    ...
    getPlaceholder(): DashboardLayoutItemPlaceholder;
}
...
export declare class LayoutItem extends Disposable implements IResizableModel {
