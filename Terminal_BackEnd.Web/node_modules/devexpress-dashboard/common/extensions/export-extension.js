...
import { ExportDialogBinder, ExportInfoManager } from './_export-dialog-binder';
const name = 'dashboardExport';
const nameAlias = 'dashboard-export';
export class DashboardExportExtension {
    constructor(dashboardControl, options = {}) {
        this.dashboardControl = dashboardControl;
        this._exportInfoContoller = new ExportInfoManager();
        this.name = name;
        ...
        this._dialogBinder = new ExportDialogBinder({
...
defaultExtensions[nameAlias] = (dashboardControl, options) => new DashboardExportExtension(dashboardControl, options);
