...
.dx-designer .dx-designer-viewport .dxrd-designer-wrapper.dxrd-designer-wrapper .dxrd-right-panel .dxrd-right-panel-content .dx-editors .dx-fieldset .dxrv-daterange-editor .dx-state-readonly.dx-widget {
  border-style: none;
}
