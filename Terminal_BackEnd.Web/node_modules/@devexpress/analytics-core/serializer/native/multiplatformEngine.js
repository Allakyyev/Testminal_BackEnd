...
export class MultiplatformEngine {
    ...
    createComputedProperty(configurableModel, configurablePropertyName, comOptions, properties, options, pure = false) {
        ...
        function subscribeProperty(model, properties, computedProperties) {
            ...
            const currentSubscriptions = (computedSubproperties === null || computedSubproperties === void 0 ? void 0 : computedSubproperties.map(x => subscribeProperty(x.model, x.properties))) || [];
            if (properties === '*') {
