    ...
    constructor({ actions, target, getClickActionParams, contextMenusEnabled, fullScreen }) {
        ...
        const updateOverlayContainer = (isFullScreen) => {
            ...
            if (isFullScreen)
                ...
                this.overlayContainer = document.body;
            if ((_c = (_b = (_a = this.component) === null || _a === void 0 ? void 0 : _a._overlay) === null || _b === void 0 ? void 0 : _b._positionController) === null || _c === void 0 ? void 0 : _c.$container[0])
        ...
        this.onOptionChanged = (e) => {
            ...
            if (e.name === 'visible' && e.value)
                if ((_b = (_a = e.component._overlay) === null || _a === void 0 ? void 0 : _a._positionController) === null || _b === void 0 ? void 0 : _b.$container[0]) {
                    ...
                    e.component._overlay._positionController.$container[0] = (_c = this.overlayContainer) !== null && _c !== void 0 ? _c : container;
                }
        };
