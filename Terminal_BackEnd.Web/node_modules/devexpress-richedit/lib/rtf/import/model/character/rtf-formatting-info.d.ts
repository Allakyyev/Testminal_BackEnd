import { UnicodeCharacterDecoder } from '../../encoding/unicode-character-decoder';
...
export declare class RtfFormattingInfo {
    ...
    private _codePage;
    activeDecoder: CharacterDecoder;
    codePageDecoder: CodePageCharacterDecoder;
    unicodeDecoder: UnicodeCharacterDecoder;
    deleted: boolean;
    constructor();
