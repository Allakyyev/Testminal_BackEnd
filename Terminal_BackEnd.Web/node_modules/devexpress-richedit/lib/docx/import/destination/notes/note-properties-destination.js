...
import { NoteNumberingRestartType, NoteProperties } from '../../../../core/model/footnotes/footnote';
...
NotePropertiesDestination.handlerTable = new MapCreator()
    .add('pos', (data) => NotePropertiesDestination.getThis(data).createPlacementDestination(data))
    .add('numFmt', (data) => NotePropertiesDestination.getThis(data).createNumberingFormatDestination(data))
    .add('numStart', (data) => new NoteNumberingStartDestination(data, NotePropertiesDestination.getThis(data).notes))
    .add('numRestart', (data) => new NoteNumberingRestartTypeDestination(data, NotePropertiesDestination.getThis(data).notes))
    .get();
