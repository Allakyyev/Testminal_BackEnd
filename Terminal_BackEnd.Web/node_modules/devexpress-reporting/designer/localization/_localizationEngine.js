    ...
    constructor(report) {
        ...
        report._localizationItems().forEach(item => {
            ...
            if (component) {
                ...
                const target = (_a = component.getLocalizationProperty(propertyName)) === null || _a === void 0 ? void 0 : _a.target;
                item.component() && this.add(item.culture(), item.component(), propertyName, item.propertyValue, target);
            }
        });
    }
