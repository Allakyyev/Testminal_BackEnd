...
export function createDateRangeEditor(_options, element, model) {
    ...
    const rangeEditor = new DateRangeEditor(rangeEditorOptions, model === null || model === void 0 ? void 0 : model.editorInputId, model === null || model === void 0 ? void 0 : model.visibilityChanged);
    if (koUtils.isSubscribable(_options.value))
